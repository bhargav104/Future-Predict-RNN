...
def get_vHv(model, direc, dataset, train_size, batch_size, args, criterion, N=1, M=15, seed=777):

    model.train()

    v = Variable(torch.from_numpy( direc.astype("float32")).cuda())
